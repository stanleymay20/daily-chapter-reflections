...
import { loadSettings } from "@/lib/app-state";
...
export const Route=createRootRouteWithContext<{queryClient:QueryClient}>()({
  head:()=>({meta:[{charSet:"utf-8"},{name:"viewport",content:"width=device-width, initial-scale=1, viewport-fit=cover"},{title:"7-Chapter Bible Study"},{name:"description",content:"A daily Bible reading and study companion powered by YouVersion Scripture."}],links:[{rel:"stylesheet",href:appCss},{rel:"icon",href:"/favicon.ico",type:"image/x-icon"}]}),
